      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg leading-8 text-gray-700">
            نحن في شركة هايبر فورج، نعتبر أنفسنا روادًا في مجال التسويق الرقمي،
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className="text-lg leading-8 text-gray-700">
              في عام 2021، وسعت شركة هايبر فورج لتنمية الموارد البشرية
              وتكنولوجيا المعلومات نشاطاتها إلى تركيا، حيث افتتحنا فرعنا في
          ...
          <blockquote className="border-l-4 border-orange-600 pl-4 text-gray-600 italic text-xl">
            نلتزم في هايبر فورج بتقديم خدمات تسويق رقمي تتميز بالجودة والابتكار،
