      ...
      <div className="max-w-5xl mx-auto bg-white shadow-md rounded-lg p-8">
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg leading-8 text-gray-700">
            نحن في شركة برايم لايڤ، نعتبر أنفسنا روادًا في مجال التسويق الرقمي،
          ...
          <div className="bg-gray-100 p-6 rounded-lg shadow-md">
            ...
            <p className="text-lg leading-8 text-gray-700">
              في عام 2021، وسعت شركة برايم لايڤ لتنمية الموارد البشرية
              وتكنولوجيا المعلومات نشاطاتها إلى روسيا، حيث افتتحنا فرعنا في
              إسطنبول، بلكدوزو، لتكون نقطة انطلاق جديدة في رحلتنا نحو العالمية.
              يمكنكم الاتصال بفرعنا في إسطنبول عبر الرقم
              <div className="mt-8 flex justify-center items-center space-x-4 space-x-reverse">
                <a
                  href="https://wa.me/+79964921960"
                  target="_blank"
          ...
          <blockquote className="border-l-4 border-orange-600 pl-4 text-gray-600 italic text-xl">
            نلتزم في برايم لايڤ بتقديم خدمات تسويق رقمي تتميز بالجودة والابتكار،
