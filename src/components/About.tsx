      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded shadow">
              ...
              <p className="text-gray-600">
                ...
                والإقامة الإستثمارية في سلطنة الامارات. حصل على درجة البكالوريوس
                في التمريض العام من الجامعة الإسلامية في غزة، وأكمل دراسته
                بحصوله على درجة الماجستير في خدمة المجتمع والصحة النفسية,
                والماجستير التطبيقي لتقنية الذكاء الاصطناعي, شارك في العديد من
                المؤتمرات الدولية في مجال الذكاء الاصطناعي وحصل على جوائز عديدة
                في مجالات مختلفة
              </p>
            </div>
            <div className="bg-white p-6 rounded shadow">
          ...
          <div className="space-y-6">
            <div className="bg-white p-6 rounded shadow">
              <p className="text-gray-600">
                في &quot;برايم لايڤ للتسويق والاستثمار&quot;، نؤمن بأن الإبداع
